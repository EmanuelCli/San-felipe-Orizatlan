...
echo "<script>alert('Los campos marcados con * son obligatorios');location.href ='javascript:history.back()';</script>";
    ...
    $mail->From     = "menu-digital@infrusch.com.mx";    // Correo Electronico para SMTP
    $mail->FromName = $Nombre; 
    $mail->AddAddress("menu-digital@infrusch.com.mx"); // DirecciÃ³n a la que llegaran los mensajes.
...
// Datos del servidor SMTP
    ...
    $mail->SMTPAuth = true; 
    $mail->Username = "menu-digital@infrusch.com.mx";  // Correo ElectrÃ³nico para SMTP
    $mail->Password = "123Menu456$"; // ContraseÃ±a para SMTP
